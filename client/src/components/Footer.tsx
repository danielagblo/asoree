    ...
    <footer className="footer-container">
      <div className="footer-grid">
        ...
        <div className="footer-newsletter-col">
          ...
          <p className="footer-desc">support@asoree.com</p>
          <p className="footer-desc">+234 800 555 0199</p>
          <Link to="/contact-us" className="footer-link" style={{ marginTop: '10px', display: 'inline-block' }}>
      ...
      <div className="footer-bottom">
        <p className="footer-text">&copy; {new Date().getFullYear()} Asoree. All rights reserved. Crafted with purpose. Designed by <a href="https://skytechghana.com/" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'underline' }}>SkyTech Ghana</a>.</p>
      </div>
    </footer>
  )
}
