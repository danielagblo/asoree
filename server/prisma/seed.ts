  ...
  if (existingProducts === 0) {
    await prisma.product.createMany({
      data: [
        ...
        { title: 'Afroase Aso Oke & Linen Pants', price: 269.77, originalPrice: 285.00, category: 'Bottoms', image: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&w=600&q=80' },
